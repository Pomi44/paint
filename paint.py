...
class Paint(object):
    ...
    def bind_events(self):
        ...
        self.c.bind('<Button-3>', self.bucket_fill)
    ...
    def use_bucket_fill(self):
        self.drawing_shape = 'bucket_fill'
    ...
    def bucket_fill(self, event):
        ...
        target_color_hex = '#{:02x}{:02x}{:02x}'.format(*target_color)
        ...
        self._flood_fill(x, y, target_color, hex_to_rgb(self.color))
        self.update_canvas()
